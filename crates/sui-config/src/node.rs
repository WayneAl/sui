...
pub fn default_protocol_key_pair_path() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("data/protocol.key")
}

pub fn default_worker_key_pair_path() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("data/worker.key")
}

pub fn default_network_key_pair_path() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("data/network.key")
}

pub fn default_account_key_pair_path() -> PathBuf {
    Path::new(env!("CARGO_MANIFEST_DIR")).join("data/account.key")
}
